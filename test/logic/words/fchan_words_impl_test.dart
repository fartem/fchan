...
void main() {
  group('Check words in app', () {
    FChanWords fChanWords = FChanWordsImpl();
    test('Check Home title', () {
      expect(
        fChanWords.homeTitle,
        'Home',
      );
    });
    test('Check Board words', () {
      expect(
    ...
    test('Check Explore words', () {
      expect(
        fChanWords.exploreBoardsTitle,
        'Explore boards',
      );
    });
    test('Check Catalog words', () {
      expect(
        fChanWords.catalogIsEmpty,
        'Catalog is empty',
      );
    });
    test('Check History words', () {
      expect(
